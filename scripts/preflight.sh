...
for s in install lint format-check typecheck test-unit test-integration test-e2e build security-check dependency-audit smoke-test verify cache-hit-audit production-readiness-check check-execplan-state; do
