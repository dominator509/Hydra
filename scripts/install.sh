...
need cargo-audit   || cargo install cargo-audit --locked --version 0.22.2
need cargo-deny    || cargo install cargo-deny --locked --version 0.19.9
need wasm-tools    || cargo install wasm-tools --locked --version 1.240.0
need cargo-sqlx    || cargo install sqlx-cli --no-default-features --features postgres --locked --version 0.8.6
